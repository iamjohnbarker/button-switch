...
function createWindow () {
  ...
  win = new BrowserWindow({width: 600, height: 675})
...
function createDocsWindow () {
  const modalPath = path.join('file://', __dirname, './assets/pages/docsWindow.html')
...
function createControllerCustomisationWindow () {
  const modalPath = path.join('file://', __dirname, './assets/customisation/controllerCustomisation.html')
  let win = new BrowserWindow({ width: 545, height: 630 })
...
function createStreamDeckCustomisationWindow () {
  const modalPath = path.join('file://', __dirname, './assets/customisation/streamDeckCustomisation.html')
  let win = new BrowserWindow({ width: 335, height: 630 })
...
function createMIDICustomisationWindow () {
  const modalPath = path.join('file://', __dirname, './assets/customisation/midiCustomisation.html')
