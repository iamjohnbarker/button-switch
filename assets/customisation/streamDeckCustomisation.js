...
for (var i = 0; i < sdArray.length; i++) {
	...
	preappend.setAttribute("class", "streamdeck__number");
	preappend.appendChild(label);
	label.setAttribute("class", "streamdeck__number-inner");
	label.setAttribute("for", "sd");
	label.innerText = iPlus;
	div.setAttribute("class", "mb-3 streamdeck-selectors");
	select.setAttribute("class", "streamdeck__dropdown");
	select.setAttribute("id", "sd" + sdArray[i]);
	div.appendChild(preappend);
	div.appendChild(select);
	// div.appendChild(numberInput);
	numberInput.setAttribute("class", "number-input");
	document.getElementById("streamdeck__options").appendChild(div);
...
document
	.getElementById("streamdeck__options")
