...
document.getElementById('cbr1').addEventListener('change', function (e) {
  storage.set('cbr1-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON R1 MIDI
...
document.getElementById('cbr2').addEventListener('change', function (e) {
  storage.set('cbr2-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON R2 MIDI
...
document.getElementById('cbl1').addEventListener('change', function (e) {
  storage.set('cbl1-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON L1 MIDI
...
document.getElementById('cbl2').addEventListener('change', function (e) {
  storage.set('cbl2-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON L2 MIDI
...
document.getElementById('cb1').addEventListener('change', function (e) {
  storage.set('cb1-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON 1 MIDI
...
document.getElementById('cb2').addEventListener('change', function (e) {
  storage.set('cb2-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON 2 MIDI
...
document.getElementById('cb3').addEventListener('change', function (e) {
  storage.set('cb3-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON 3 MIDI
...
document.getElementById('cb4').addEventListener('change', function (e) {
  storage.set('cb4-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON 4 MIDI
...
document.getElementById('cbstart').addEventListener('change', function (e) {
  storage.set('cbstart-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON START MIDI
...
document.getElementById('cbselect').addEventListener('change', function (e) {
  storage.set('cbselect-button', {value: e.target.value, class: e.target.selectedOptions[0].className, index: e.target.selectedIndex}, function(error) {
    if (error) throw error;
  });
});
// BUTTON SELECT MIDI
